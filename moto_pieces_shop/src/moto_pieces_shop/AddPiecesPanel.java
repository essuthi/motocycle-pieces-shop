 ...
 */
public class AddPiecesPanel extends JPanel{
    
    public JLabel label_ajout = new JLabel("AJOUT DE PIECES");
    ...
    public String[] titles = {"Identifiant" ,"Nom", "Quantité" ,"Prix d'achat" ,"Premier Prix de Vente" ,"Premier Prix de Vente"};
    
    public JScrollPane scrollpan = new JScrollPane();
    
    public AddPiecesPanel(){
