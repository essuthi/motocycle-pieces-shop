 ...
 */
public class AddAchatsPanel extends JPanel{
    
    public JLabel label_ajout = new JLabel("AJOUT D'ACHATS");
    public JLabel label_identifiant_acheteur = new JLabel("IDENTIFIANT ACHETEUR");
    ...
    public String[] titles = {"identifiant pièce", "prix d'achat" ,"Quantité" };
    
    public JScrollPane scrollpan = new JScrollPane();
    
    public AddAchatsPanel(){
        ...
        this.add(label_identifiant_acheteur);
        this.add(label_date);
        ...
        label_identifiant_acheteur.setBounds(400, 50, 150, 30);
